...
public class TestObjects{
    ...
    public static final String Sign_in 			= "//*[@name = 'Sign in' or @resource-id='Hello. Sign in']";
    ...
    public static final String SignOut				= "//*[@name = 'Not "+dataProvider.nameonly+"? Sign out' or @text= 'Not Daniel? Sign out']";
    ...
    //NewChange to britain
    public static final String ChangeCountry = "//*[@name = 'Change Country']";
    public static final String UK            = "//*[@name = 'United Kingdom']";
